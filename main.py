...
def bandwidth_experiment():
    ...
    ***DO THIS***
    ...
    # Save result
    return generate_figures("Figure_Bandwidth_Experiment",
                     'Bandwidth (Kbps)',
                     BW,
...
def network_delay_experiment():
    ...
    ***DO THIS***
    ...
    # Save result
    return generate_figures("Figure_Network_Delay_Experiment",
                     'Network Delay (msec)',
                     delay,
...
def generate_final_figure(sresult, bresult, nresult):
    ...
    fig, ax = plt.subplots()
    ax.boxplot((sresult, bresult, nresult))

    ax.set_title('generate_final_figure')
    ax.set_xlabel('kind_of_experiment')
    ax.set_ylabel('Improvement (ms)')

    ax.set_xticklabels(('segment_size_experiment', 'bandwidth_experiment', 'network_delay_experiment'), fontsize=8)
    ax.set_ylim((1, 10000))
    ax.set_yscale('log')

    fig.savefig('results/generate_final_figure.png')
    plt.close(fig)
...
#    generate_final_figure([10, 20, 30], [100, 200, 300], [400, 500, 600])
